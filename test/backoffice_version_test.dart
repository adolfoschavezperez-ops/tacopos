...
void main() {
  test('Backoffice version source returns 1.1.10', () {
    expect(BackofficeVersion.version, '1.1.10');
    expect(BackofficeVersion.label, 'Backoffice v1.1.10');
  });
  ...
  test('Android pubspec version remains intact', () {
    ...
    expect(pubspec, contains('version: 1.5.1+17'));
  });
}
